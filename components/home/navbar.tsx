 ...
 const navItems = ["Home", "Projects"]
  ...
  return (
    <div className="flex justify-center w-full fixed top-0 left-0 z-50">
      <div className={`flex items-center justify-between px-6 py-4 rounded-sm shadow-lg w-full container relative transition-colors duration-300 ${isScrolled ? 'bg-white/60 backdrop-blur-sm' : 'bg-transparent'}`}>
